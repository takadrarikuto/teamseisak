...
if (m_mou_x > 520 && m_mou_x < 197 * (std + 1) && m_mou_y>302 + k * (l - 1) && m_mou_y < 300 + 73 * l)
{
	...
	Font::StrDraw(L"¯‚Ì–¼‘O‚ÉƒJ[ƒ\ƒ‹‡‚í‚¹‚Ä¶ƒNƒŠƒbƒN‚·‚é‚Æ‚»‚Ì¯À‚É‚ ‚é", 80, 25, 25, c);
	Font::StrDraw(L"Žå‚È¯‚Ìà–¾‚ª‚³‚ê‚Ü‚·B", 80, 50, 25, c);
	Font::StrDraw(L"¯À‚ÌŠG‚ÉƒJ[ƒ\ƒ‹‚ð‡‚í‚¹‚ÄƒNƒŠƒbƒN‚·‚é‚Æ¯À‚»‚Ì‚à‚Ì‚Ì", 80, 100, 25, c);
	Font::StrDraw(L"à–¾‚É“ü‚è‚Ü‚·B", 80, 125, 25, c);
